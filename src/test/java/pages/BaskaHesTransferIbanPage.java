...
public class BaskaHesTransferIbanPage {

        public BaskaHesTransferIbanPage() {
        PageFactory.initElements(new AppiumFieldDecorator(Driver.getDriver()), this);
    }

    @AndroidFindBy(xpath = "(//android.widget.TextView[@content-desc=\"IBAN Alanı \"])[2]")
    public WebElement ibanGiris;
